...
const accountModal = ( props ) => {
  ...
  let labelError = {};
  props.numbers.forEach((el) => {
    labelError[el] = props.error[el] ? 'colorWarning' : '';
  });
  return(
    <Modal show={ props.show !== false } onHide={ () => props.close() }>
      ...
      <Modal.Body style={bodyHeight}>
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="8"
                 placeholder={ props.message.labels.order }
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="8"
                 placeholder={ props.message.labels.shipment }
                 changeHandler={ props.handleChange.bind(this) }
                 name="address"
                 disable={ props.disable }
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <div class="col-xs-12 col-md-4">
            <DatePicker
              ...
              placeholderText={ props.message.labels.date }
            />
          </div>
        </div>
        <div class="col-xs-12 marginTop10px">
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="4"
                 placeholder={ props.message.labels.amount }
                 changeHandler={ props.handleChange.bind(this) }
                 name="amount"
                 disable={ props.disable }
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="4"
                 placeholder={ props.message.labels.receipt }
                 changeHandler={ props.handleChange.bind(this) }
                 name="receipt"
                 disable={ props.disable }
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="4"
                 placeholder={ props.message.labels.quantity.placeholder }
                 changeHandler={ props.handleChange.bind(this) }
                 name="locs"
                 disable={ props.disable }
        ...
        <div class="col-xs-12 marginTop10px">
          ...
          <Input heightRow="8"
                 placeholder={ props.message.labels.remarks }
                 changeHandler={ props.handleChange.bind(this) }
                 name="remarks"
                 disable={ props.disable }
